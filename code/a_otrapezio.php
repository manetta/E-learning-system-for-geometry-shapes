...
<?php		 
		if($area==$right)
		{
			insertAOTrapezio($user);
			//dispTrapezio($x,$y,$mibase,$mebase,$height,$c1,$c2,$c3,$area,0);
			dispΟTrapezio($x,$y,$mibase,$mebase,$height,$c1,$c2,$c3,$area,0);
			//dispRect($x,$y,$length,$c1,$c2,$c3,$area,$perimeter,0);
		}
		else
		{	
			//echo 'Το εμβαδόν που έδωσες δεν είναι σωστό!';
			//dispTrapezio($x,$y,$mibase,$mebase,$height,$c1,$c2,$c3,0,1);
			dispΟTrapezio($x,$y,$mibase,$mebase,$height,$c1,$c2,$c3,0,1);
		}
	}
