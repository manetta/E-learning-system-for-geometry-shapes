...
try
{
	...
	{
		echo '</br></br>';
		throw new Exception('Δεν έχετε συμπληρώση της μικρής βάσης!');
	}
	...
	{
		echo '</br></br>';
		throw new Exception('Δεν έχετε συμπληρώση το μήκος της μεγάλης βάσης!');
	}
	...
	{
		echo '</br></br>';
		throw new Exception('Δεν έχετε συμπληρώση το ύψος!');
	}
...
<?php
	dispTrapezio($x,$y,$mibase,$mebase,$height,0,0,0,0,0);
}
